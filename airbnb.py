...
st.set_page_config(page_title="AirBnb-Analysis by GUNACHANDRA ANDE!!!", page_icon=":bar_chart:", layout="wide")
...
if SELECT == "Explore Data":
 ...
 if fl is not None:
    ...
    default_file_path = r"C:\Users\91832\Desktop\airbnb\AB_NYC_2019.csv"
...
if SELECT == "Contact":
    Name = (f'{"Name :"}  {"GUNACHANDRA ANDE"}')
    mail = (f'{"Mail :"}  {"guna.ande07@gmail.com"}')
    description = "An Aspiring DATA-SCIENTIST..!"
    social_media = {
        "GITHUB": "https://www.github.com/Guna-Ande",
        "LINKEDIN": "https://www.linkedin.com/in/gunachandra-ande-b07455301/"}

    col1, col2 = st.columns(2)
    col1.image(Image.open("C:\\Users\\91832\\Downloads\\HD Airbnb Logo With Symbol Sign Icon PNG Image.jpeg"), width=300)
